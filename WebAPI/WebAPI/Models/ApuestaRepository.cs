...
namespace WebAPI.Models
{
    public class ApuestaRepository
    {
        ...
        internal List<ApuestaDTO1> RetrieveEmail(String email_fk)
        {

            MySqlConnection con = Connect(); 
            MySqlCommand command = con.CreateCommand();
            command.CommandText = "select id_apuesta ,id_mercado ,tipo_apuesta, cuota, dinero_apostado from apuesta where email_fk = @A";
